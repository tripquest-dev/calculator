...
// Define start locations from locationMap
...
export default function SafariPricingTool() {
  ...
  const displayHotels = async (dayIndex) => {
    ...
    try {
      console.log(
        `Fetching hotel for Day ${day.day}: https://calculator-gaql.onrender.com/api/hotels/hotel-price?date=${formattedDate}&location=${location}`
      );
  ...
  const locationMap = {
    ...
    NS: ["NG", "CS", "NS", "MM", "TA", "LM", "FZNZ", "FDAR", "FARK", "FNBO"],
    LE: [
      "NG",
      "CS",
      "TA",
